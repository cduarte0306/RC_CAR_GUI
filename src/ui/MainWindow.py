...
class MainWindow(QMainWindow):
    ...
    def __connectSignals(self):
        ...
        self.__streamWindow.stereoMonoModeChanged.connect(self.__consumer.uploadVideoFile)
        ...
        self.__streamWindow.disparityMaxDiffChanged.connect(self.__consumer.setDisp12MaxDiff)
